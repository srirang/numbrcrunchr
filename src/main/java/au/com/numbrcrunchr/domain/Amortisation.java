...
public class Amortisation {
	...
	public String toString() {
		return new ToStringBuilder(this).append("period", period).append(
				"principal", getPrincipal()).append("interest", getInterest())
				.append("loanBalance", getLoanBalance()).append("repayment",
						getRepayment()).toString();
	}
