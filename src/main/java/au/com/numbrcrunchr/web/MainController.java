...
public class MainController implements Serializable {
	...
	public String performFeasibilityAnalysis() {
		...
		projection = getFeasibilityAnalysisProjectionService()
				.applyProjectionFor(getProperty(), getNumberOfYears() - 1,
	...
	public String getGearing() {
		// return getFeasibilityAnalysisResult() == null ? "Negative"
		// : getFeasibilityAnalysisResult().getGearing();
		return "Negative";
	}
